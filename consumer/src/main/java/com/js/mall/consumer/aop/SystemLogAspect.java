...
import com.js.common.IpInfoUtil;
import com.js.common.ThreadPoolUtil;
...
//            }
    ...
    public void after(JoinPoint joinPoint){//返回coast time
        try{
            ...
            //手写线程池，模拟多线程,SaveSystemLogThread线程执行run方法,将日志对象存储到数据库
            ThreadPoolUtil.getPool().execute(new SaveSystemLogThread(log,umsLogService));
