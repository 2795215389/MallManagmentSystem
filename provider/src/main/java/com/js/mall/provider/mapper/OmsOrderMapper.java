...
import com.js.api.model.OmsOrderExample;
...
public interface OmsOrderMapper {
    ...
    @Results({
        ...
        @Result(property = "orderItemList",javaType = List.class,column="id",
                many = @Many(select="com.js.mall.provider.mapper.OmsOrderItemMapper.selectItemByOrderid")),
        @Result(property = "historyList",javaType = List.class,column="id",
                many = @Many(select="com.js.mall.provider.mapper.OmsOrderOperateHistoryMapper.selectHistoryByOrderId"))
