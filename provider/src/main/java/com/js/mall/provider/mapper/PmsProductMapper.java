package com.js.mall.provider.mapper;
...
public interface PmsProductMapper {
    ...
    @Results({
        ...
        @Result(column="product_category_id", property="cateParentId",
                one = @One(select="com.js.mall.provider.mapper.PmsProductCategoryMapper.selectParentIdById")
        ),
        @Result(property = "productLadderList",javaType = List.class,column="id",//阶梯价格
                many = @Many(select="com.js.mall.provider.mapper.PmsProductLadderMapper.selectLadderByProductId")
        ),
        @Result(property = "productFullReductionList",javaType = List.class,column="id",//满减价格
                many = @Many(select="com.js.mall.provider.mapper.PmsProductFullReductionMapper.selectFullByProductId")
        ),
        @Result(property = "memberPriceList",javaType = List.class,column="id",//会员价格
                many = @Many(select="com.js.mall.provider.mapper.PmsMemberPriceMapper.selectMemberByParentId")
        ),
        @Result(property = "skuStockList",javaType = List.class,column="id",//SKU库存表
                many = @Many(select="com.js.mall.provider.mapper.PmsSkuStockMapper.selectProductSkuByParentId")
        ),
        @Result(property = "productAttributeValueList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.js.mall.provider.mapper.PmsProductAttributeValueMapper.selectAttributeByParentId")
        ),

        @Result(property = "subjectProductRelationList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.js.mall.provider.mapper.CmsSubjectProductRelationMapper.selectSubjectProductById")
        ) ,
        @Result(property = "prefrenceAreaProductRelationList",javaType = List.class,column="id",//存储信息表
                many = @Many(select="com.js.mall.provider.mapper.CmsPrefrenceAreaProductRelationMapper.selectPrefrenceProductById")
        )
