...
import com.js.api.model.PmsProductAttributeCategory;
import com.js.api.model.PmsProductAttributeCategoryExample;
...
// 也就是主外键查询 pms_product_attribute_category的id和pms_product_attribute表的product_attribute_category_id键关联
    ...
    @Results({
            ...
            @Result(property = "productAttributeList",javaType = List.class,column="parent_id",
                    many = @Many(select="com.js.mall.provider.mapper.PmsProductAttributeMapper.selectAttributeByCategoryId"))
    })
    //每个种类
